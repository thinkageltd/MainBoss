	...
	public class dsBackupFileName_1_0_4_79_To_1_0_10_23 : DBDataSet {
		...
		public class BackupFileNameDataTable : DBIDataTable {
			...
			public BackupFileNameRow AddNewBackupFileNameRow() {
				return ((BackupFileNameRow)(((DBDataSet)this.DataSet).DB.AddNewRowAndBases((DBDataSet)this.DataSet, dsBackupFileName_1_0_4_79_To_1_0_10_23.Schema.T.BackupFileName)));
			}
