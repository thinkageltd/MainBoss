...
namespace Thinkage.MainBoss.Database {
	...
	public class dsBackupFileName_1_0_4_79_To_1_0_10_23 : DBDataSet {
		...
		public class VAccessor {
			...
			public VAccessor(dsBackupFileName_1_0_4_79_To_1_0_10_23 this_dataset )
			{
			}
			#endregion
		}
		...
		public dsBackupFileName_1_0_4_79_To_1_0_10_23() : base() {
			CommonCTOR();
		}
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
		public dsBackupFileName_1_0_4_79_To_1_0_10_23(DBClient db) : base(Schema, db) {
			CommonCTOR();
		}
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
		public dsBackupFileName_1_0_4_79_To_1_0_10_23(IServer server) : base(Schema, server) {
			CommonCTOR();
		}
#if SerializationSupport
		protected dsBackupFileName_1_0_4_79_To_1_0_10_23(SerializationInfo info, StreamingContext context) {
		...
		protected override void InitClass() {
			this.DataSetName = "dsBackupFileName_1_0_4_79_To_1_0_10_23";
			this.Prefix = "";
		...
		public class TAccessor {
			public TAccessor( dsBackupFileName_1_0_4_79_To_1_0_10_23 this_dataset ) {
		...
		public class DTAccessor {
			public DTAccessor( dsBackupFileName_1_0_4_79_To_1_0_10_23 this_dataset ) {
			}
		}
		#endregion
		...
		public class BackupFileNameDataTable : DBICustomDataTable<BackupFileNameRow> {
			...
			public BackupFileNameRow AddNewRow() => (BackupFileNameRow)DataSet.DB.AddNewRowAndBasesForGeneratedClass(DataSet, dsBackupFileName_1_0_4_79_To_1_0_10_23.Schema.T.BackupFileName);
			protected override DBIDataRow NewDBIRowFromBuilder(System.Data.DataRowBuilder builder) => new BackupFileNameRow(builder);
			public new dsBackupFileName_1_0_4_79_To_1_0_10_23 DataSet => (dsBackupFileName_1_0_4_79_To_1_0_10_23)base.DataSet;
		}
		...
		public class SchemaClass : DBI_Database {
			...
			private SchemaClass() {
				...
				CompleteDBI(System.Reflection.Assembly.GetExecutingAssembly(), "manifest://localhost/Thinkage/MainBoss/Database/Upgrade/Schema/dsBackupFileName_1_0_4_79_To_1_0_10_23.xafdb", typeof(dsBackupFileName_1_0_4_79_To_1_0_10_23)
				);
			 }
			/// <summary>
			...
			public class DBI_BackupFileName : DBIDataDBI_Table {
				...
				public override void SetupVariables() {
					...
					System.Diagnostics.Debug.Assert(Columns.Count == 4, "Table 'BackupFileName' column count mismatch");
					__Id = Columns["Id"];
