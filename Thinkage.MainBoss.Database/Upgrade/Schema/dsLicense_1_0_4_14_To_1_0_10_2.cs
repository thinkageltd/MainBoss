...
namespace Thinkage.MainBoss.Database {
	...
	public class dsLicense_1_0_4_14_To_1_0_10_2 : DBDataSet {
		...
		public class VAccessor {
			...
			public VAccessor(dsLicense_1_0_4_14_To_1_0_10_2 this_dataset )
			{
			}
			#endregion
		}
		...
		public dsLicense_1_0_4_14_To_1_0_10_2() : base() {
			CommonCTOR();
		}
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
		public dsLicense_1_0_4_14_To_1_0_10_2(DBClient db) : base(Schema, db) {
			CommonCTOR();
		}
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
		public dsLicense_1_0_4_14_To_1_0_10_2(IServer server) : base(Schema, server) {
			CommonCTOR();
		}
#if SerializationSupport
		protected dsLicense_1_0_4_14_To_1_0_10_2(SerializationInfo info, StreamingContext context) {
		...
		protected override void InitClass() {
			this.DataSetName = "dsLicense_1_0_4_14_To_1_0_10_2";
			this.Prefix = "";
		...
		public class TAccessor {
			public TAccessor( dsLicense_1_0_4_14_To_1_0_10_2 this_dataset ) {
		...
		public class DTAccessor {
			public DTAccessor( dsLicense_1_0_4_14_To_1_0_10_2 this_dataset ) {
			}
		}
		#endregion
		...
		public class LicenseDataTable : DBICustomDataTable<LicenseRow> {
			...
			internal class FAccessor {
				public FAccessor(LicenseDataTable t) {
				  ...
				  this.ApplicationName = t.Columns.FindColumnDuringTableConstruction(SchemaClass.Instance.T.License.F.ApplicationName);
				  ...
				  this.ExpiryModelName = t.Columns.FindColumnDuringTableConstruction(SchemaClass.Instance.T.License.F.ExpiryModelName);
				  ...
				  this.LicenseModelName = t.Columns.FindColumnDuringTableConstruction(SchemaClass.Instance.T.License.F.LicenseModelName);
				...
				/// <summary>
				/// Denotes the License's ApplicationID column with type integer(nonnull, 32) with labelkey='ApplicationID'
				/// </summary>
				...
				/// <summary>
				/// Denotes the License's ExpiryModelName column with type string(nonnull, minlength 1, maxlength 150, maxlines 0, trim) with labelkey='ExpiryModelName'
				/// </summary>
				...
				/// <summary>
				/// Denotes the License's LicenseModelName column with type string(nonnull, minlength 1, maxlength 150, maxlines 0, trim) with labelkey='LicenseModelName'
				/// </summary>
			...
			public LicenseRow AddNewRow() => (LicenseRow)DataSet.DB.AddNewRowAndBasesForGeneratedClass(DataSet, dsLicense_1_0_4_14_To_1_0_10_2.Schema.T.License);
			protected override DBIDataRow NewDBIRowFromBuilder(System.Data.DataRowBuilder builder) => new LicenseRow(builder);
			public new dsLicense_1_0_4_14_To_1_0_10_2 DataSet => (dsLicense_1_0_4_14_To_1_0_10_2)base.DataSet;
		}
		#region LicenseRow
		[Thinkage.Libraries.Translation.Invariant]
		public class LicenseRow : DBICustomDataRow<LicenseDataTable> {
			...
			public class FAccessor {
				...
				/// Denotes the License's ExpiryModelName column with type string(nonnull, minlength 1, maxlength 150, maxlines 0, trim) with labelkey='ExpiryModelName'
				/// </summary>
				public System.String ExpiryModelName {
					get {
							return (System.String)Schema.T.License.F.ExpiryModelName.EffectiveType.GenericAsNativeType(this_table.F.ExpiryModelName[this_row], typeof(System.String));
					}
				...
				/// Denotes the License's LicenseModelName column with type string(nonnull, minlength 1, maxlength 150, maxlines 0, trim) with labelkey='LicenseModelName'
				/// </summary>
				public System.String LicenseModelName {
					get {
							return (System.String)Schema.T.License.F.LicenseModelName.EffectiveType.GenericAsNativeType(this_table.F.LicenseModelName[this_row], typeof(System.String));
					}
		...
		public class SchemaClass : DBI_Database {
			...
			private SchemaClass() {
				...
				CompleteDBI(System.Reflection.Assembly.GetExecutingAssembly(), "manifest://localhost/Thinkage/MainBoss/Database/Upgrade/Schema/dsLicense_1_0_4_14_To_1_0_10_2.xafdb", typeof(dsLicense_1_0_4_14_To_1_0_10_2)
				);
			 }
			/// <summary>
		...
		public class PathClass {
			...
			public class PathToLicenseRow : DBI_PathToRow {
				...
				public class FAccessor {
					...
					/// <summary>
					/// Provides the path to License's ApplicationID with type integer(nonnull, 32) and labelkey='ApplicationID'
					/// </summary>
					...
					/// <summary>
					/// Provides the path to License's ExpiryModelName with type string(nonnull, minlength 1, maxlength 150, maxlines 0, trim) and labelkey='ExpiryModelName'
					/// </summary>
					...
					/// <summary>
					/// Provides the path to License's LicenseModelName with type string(nonnull, minlength 1, maxlength 150, maxlines 0, trim) and labelkey='LicenseModelName'
					/// </summary>
