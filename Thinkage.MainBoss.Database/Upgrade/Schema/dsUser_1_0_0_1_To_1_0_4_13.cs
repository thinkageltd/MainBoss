...
namespace Thinkage.MainBoss.Database {
	...
	public class dsUser_1_0_0_1_To_1_0_4_13 : DBDataSet {
		...
		public class VAccessor {
			...
			public VAccessor(dsUser_1_0_0_1_To_1_0_4_13 this_dataset )
			{
			}
			#endregion
		}
		...
		public dsUser_1_0_0_1_To_1_0_4_13() : base() {
			CommonCTOR();
		}
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
		public dsUser_1_0_0_1_To_1_0_4_13(DBClient db) : base(Schema, db) {
			CommonCTOR();
		}
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
		public dsUser_1_0_0_1_To_1_0_4_13(IServer server) : base(Schema, server) {
			CommonCTOR();
		}
#if SerializationSupport
		protected dsUser_1_0_0_1_To_1_0_4_13(SerializationInfo info, StreamingContext context) {
		...
		protected override void InitClass() {
			this.DataSetName = "dsUser_1_0_0_1_To_1_0_4_13";
			this.Prefix = "";
		...
		public class TAccessor {
			public TAccessor( dsUser_1_0_0_1_To_1_0_4_13 this_dataset ) {
		...
		public class DTAccessor {
			public DTAccessor( dsUser_1_0_0_1_To_1_0_4_13 this_dataset ) {
		...
		public class UserDataTable : DBIDataTable {
			...
			internal class FAccessor {
				public FAccessor(UserDataTable t) {
				  ...
				  this.IsGroup = (DBIDataColumn)t.Columns["IsGroup"];
			...
			public UserRow AddNewUserRow() {
				return ((UserRow)(((DBDataSet)this.DataSet).DB.AddNewRowAndBases((DBDataSet)this.DataSet, dsUser_1_0_0_1_To_1_0_4_13.Schema.T.User)));
			}
		...
		public class SchemaClass : DBI_Database {
			...
			private SchemaClass() {
				...
				__User = new DBI_User();
				Tables.Add( __User);
				CompleteDBI(System.Reflection.Assembly.GetExecutingAssembly(), "manifest://localhost/Thinkage/MainBoss/Database/Upgrade/Schema/dsUser_1_0_0_1_To_1_0_4_13.xafdb", typeof(dsUser_1_0_0_1_To_1_0_4_13));
			 }
			/// <summary>
