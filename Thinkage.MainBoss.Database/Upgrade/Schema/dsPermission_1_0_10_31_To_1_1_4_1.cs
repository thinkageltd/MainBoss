...
namespace Thinkage.MainBoss.Database {
	...
	public class dsPermission_1_0_10_31_To_1_1_4_1 : DBDataSet {
		...
		public class PermissionDataTable : DBICustomDataTable<PermissionRow> {
			...
			public PermissionRow AddNewRow() => (PermissionRow)DataSet.DB.AddNewRowAndBasesForGeneratedClass(DataSet, dsPermission_1_0_10_31_To_1_1_4_1.Schema.T.Permission);
			protected override DBIDataRow NewDBIRowFromBuilder(System.Data.DataRowBuilder builder) => new PermissionRow(builder);
			public new dsPermission_1_0_10_31_To_1_1_4_1 DataSet => (dsPermission_1_0_10_31_To_1_1_4_1)base.DataSet;
		}
		...
		public class PrincipalDataTable : DBICustomDataTable<PrincipalRow> {
			...
			public PrincipalRow AddNewRow() => (PrincipalRow)DataSet.DB.AddNewRowAndBasesForGeneratedClass(DataSet, dsPermission_1_0_10_31_To_1_1_4_1.Schema.T.Principal);
		...
		public class RoleDataTable : DBICustomDataTable<RoleRow> {
			...
			public RoleRow AddNewRow() => (RoleRow)DataSet.DB.AddNewRowAndBasesForGeneratedClass(DataSet, dsPermission_1_0_10_31_To_1_1_4_1.Schema.T.Role);
		...
		public class UserDataTable : DBICustomDataTable<UserRow> {
			...
			public UserRow AddNewRow() => (UserRow)DataSet.DB.AddNewRowAndBasesForGeneratedClass(DataSet, dsPermission_1_0_10_31_To_1_1_4_1.Schema.T.User);
		...
		public class UserRoleDataTable : DBICustomDataTable<UserRoleRow> {
			...
			public UserRoleRow AddNewRow() => (UserRoleRow)DataSet.DB.AddNewRowAndBasesForGeneratedClass(DataSet, dsPermission_1_0_10_31_To_1_1_4_1.Schema.T.UserRole);
		...
		public class UserPermissionDataTable : DBICustomDataTable<UserPermissionRow> {
			...
			public UserPermissionRow AddNewRow() => (UserPermissionRow)DataSet.DB.AddNewRowAndBasesForGeneratedClass(DataSet, dsPermission_1_0_10_31_To_1_1_4_1.Schema.T.UserPermission);
