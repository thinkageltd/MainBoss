...
namespace Thinkage.MainBoss.Database {
	...
	public class dsPermission_1_0_10_31_To_1_1_4_1 : DBDataSet {
		...
		public class VAccessor {
			...
			public VAccessor(dsPermission_1_0_10_31_To_1_1_4_1 this_dataset )
			{
			}
			#endregion
		}
		...
		public dsPermission_1_0_10_31_To_1_1_4_1() : base() {
			CommonCTOR();
		}
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
		public dsPermission_1_0_10_31_To_1_1_4_1(DBClient db) : base(Schema, db) {
			CommonCTOR();
		}
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
		public dsPermission_1_0_10_31_To_1_1_4_1(IServer server) : base(Schema, server) {
			CommonCTOR();
		}
#if SerializationSupport
		protected dsPermission_1_0_10_31_To_1_1_4_1(SerializationInfo info, StreamingContext context) {
		...
		protected override void InitClass() {
			this.DataSetName = "dsPermission_1_0_10_31_To_1_1_4_1";
			this.Prefix = "";
		...
		public class TAccessor {
			public TAccessor( dsPermission_1_0_10_31_To_1_1_4_1 this_dataset ) {
		...
		public class DTAccessor {
			public DTAccessor( dsPermission_1_0_10_31_To_1_1_4_1 this_dataset ) {
		...
		public class PermissionDataTable : DBIDataTable {
			...
			public PermissionRow AddNewPermissionRow() {
				return ((PermissionRow)(((DBDataSet)this.DataSet).DB.AddNewRowAndBases((DBDataSet)this.DataSet, dsPermission_1_0_10_31_To_1_1_4_1.Schema.T.Permission)));
			}
		...
		public class PermissionRow : DBIDataRow {
			...
			public PrincipalRow PrincipalIDParentRow {
				get {
					return ((dsPermission_1_0_10_31_To_1_1_4_1)Table.DataSet).T.Principal.RowFind<PrincipalRow>(F.PrincipalID);
				}
			}
		...
		public class PrincipalDataTable : DBIDataTable {
			...
			public PrincipalRow AddNewPrincipalRow() {
				return ((PrincipalRow)(((DBDataSet)this.DataSet).DB.AddNewRowAndBases((DBDataSet)this.DataSet, dsPermission_1_0_10_31_To_1_1_4_1.Schema.T.Principal)));
			}
			protected override DataRow NewRowFromBuilder(DataRowBuilder builder) {
		...
		public class PrincipalRow : DBIDataRow {
			...
			public RoleRow RoleIDParentRow {
				get {
					return ((dsPermission_1_0_10_31_To_1_1_4_1)Table.DataSet).T.Role.RowFind<RoleRow>(F.RoleID);
				}
			}

			public UserRow UserIDParentRow {
				get {
					return ((dsPermission_1_0_10_31_To_1_1_4_1)Table.DataSet).T.User.RowFind<UserRow>(F.UserID);
				}
			}

			public IEnumerable<PermissionRow> GetPermissionPrincipalIDChildRows() {
				return ((dsPermission_1_0_10_31_To_1_1_4_1)Table.DataSet).T.Permission.OfType<PermissionRow>().Where(r => Schema.T.Principal.F.Id.EffectiveType.GenericEquals(r.F.PrincipalID, F.Id));
			}
			public IEnumerable<RoleRow> GetRolePrincipalIDChildRows() {
				return ((dsPermission_1_0_10_31_To_1_1_4_1)Table.DataSet).T.Role.OfType<RoleRow>().Where(r => Schema.T.Principal.F.Id.EffectiveType.GenericEquals(r.F.PrincipalID, F.Id));
			}
			public IEnumerable<UserRow> GetUserPrincipalIDChildRows() {
				return ((dsPermission_1_0_10_31_To_1_1_4_1)Table.DataSet).T.User.OfType<UserRow>().Where(r => Schema.T.Principal.F.Id.EffectiveType.GenericEquals(r.F.PrincipalID, F.Id));
			}
			public IEnumerable<UserRoleRow> GetUserRolePrincipalIDChildRows() {
				return ((dsPermission_1_0_10_31_To_1_1_4_1)Table.DataSet).T.UserRole.OfType<UserRoleRow>().Where(r => Schema.T.Principal.F.Id.EffectiveType.GenericEquals(r.F.PrincipalID, F.Id));
			}
		}
		#endregion
		...
		public class RoleDataTable : DBIDataTable {
			...
			public RoleRow AddNewRoleRow() {
				return ((RoleRow)(((DBDataSet)this.DataSet).DB.AddNewRowAndBases((DBDataSet)this.DataSet, dsPermission_1_0_10_31_To_1_1_4_1.Schema.T.Role)));
			}
			protected override DataRow NewRowFromBuilder(DataRowBuilder builder) {
		...
		public class RoleRow : DBIDataRow {
			...
			public IEnumerable<PrincipalRow> GetPrincipalRoleIDChildRows() {
				return ((dsPermission_1_0_10_31_To_1_1_4_1)Table.DataSet).T.Principal.OfType<PrincipalRow>().Where(r => Schema.T.Role.F.Id.EffectiveType.GenericEquals(r.F.RoleID, F.Id));
			}
		}
		#endregion
		...
		public class UserDataTable : DBIDataTable {
			...
			public UserRow AddNewUserRow() {
				return ((UserRow)(((DBDataSet)this.DataSet).DB.AddNewRowAndBases((DBDataSet)this.DataSet, dsPermission_1_0_10_31_To_1_1_4_1.Schema.T.User)));
			}
			protected override DataRow NewRowFromBuilder(DataRowBuilder builder) {
		...
		public class UserRow : DBIDataRow {
			...
			public IEnumerable<UserRoleRow> GetUserRoleUserIDChildRows() {
				return ((dsPermission_1_0_10_31_To_1_1_4_1)Table.DataSet).T.UserRole.OfType<UserRoleRow>().Where(r => Schema.T.User.F.Id.EffectiveType.GenericEquals(r.F.UserID, F.Id));
			}
			public IEnumerable<UserPermissionRow> GetUserPermissionUserIDChildRows() {
				return ((dsPermission_1_0_10_31_To_1_1_4_1)Table.DataSet).T.UserPermission.OfType<UserPermissionRow>().Where(r => Schema.T.User.F.Id.EffectiveType.GenericEquals(r.F.UserID, F.Id));
			}
			public IEnumerable<PrincipalRow> GetPrincipalUserIDChildRows() {
				return ((dsPermission_1_0_10_31_To_1_1_4_1)Table.DataSet).T.Principal.OfType<PrincipalRow>().Where(r => Schema.T.User.F.Id.EffectiveType.GenericEquals(r.F.UserID, F.Id));
			}
		}
		#endregion
		...
		public class UserRoleDataTable : DBIDataTable {
			...
			public UserRoleRow AddNewUserRoleRow() {
				return ((UserRoleRow)(((DBDataSet)this.DataSet).DB.AddNewRowAndBases((DBDataSet)this.DataSet, dsPermission_1_0_10_31_To_1_1_4_1.Schema.T.UserRole)));
			}
			protected override DataRow NewRowFromBuilder(DataRowBuilder builder) {
		...
		public class UserPermissionDataTable : DBIDataTable {
			...
			public UserPermissionRow AddNewUserPermissionRow() {
				return ((UserPermissionRow)(((DBDataSet)this.DataSet).DB.AddNewRowAndBases((DBDataSet)this.DataSet, dsPermission_1_0_10_31_To_1_1_4_1.Schema.T.UserPermission)));
			}
			protected override DataRow NewRowFromBuilder(DataRowBuilder builder) {
		...
		public class SchemaClass : DBI_Database {
			...
			private SchemaClass() {
				...
				CompleteDBI(System.Reflection.Assembly.GetExecutingAssembly(), "manifest://localhost/Thinkage/MainBoss/Database/Upgrade/Schema/dsPermission_1_0_10_31_To_1_1_4_1.xafdb", typeof(dsPermission_1_0_10_31_To_1_1_4_1));
			 }
			/// <summary>
