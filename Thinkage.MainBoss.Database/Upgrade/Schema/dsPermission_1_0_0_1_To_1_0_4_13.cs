	...
	public class dsPermission_1_0_0_1_To_1_0_4_13 : DBDataSet {
		...
		public class PermissionDataTable : DBIDataTable {
			...
			internal class FAccessor {
				public FAccessor(PermissionDataTable t) {
				  ...
				  this.Grant = (DBIDataColumn)t.Columns["Grant"];
				}
				/// <summary>
			...
			public PermissionRow AddNewPermissionRow() {
				return ((PermissionRow)(((DBDataSet)this.DataSet).DB.AddNewRowAndBases((DBDataSet)this.DataSet, dsPermission_1_0_0_1_To_1_0_4_13.Schema.T.Permission)));
			}
		...
		public class PermissionRow : DBIDataRow {
			...
			public UserRow UserIDParentRow {
				get {
					return ((dsPermission_1_0_0_1_To_1_0_4_13)Table.DataSet).T.User.RowFind<UserRow>(F.UserID);
				}
			}
		...
		public class UserDataTable : DBIDataTable {
			...
			public UserRow AddNewUserRow() {
				return ((UserRow)(((DBDataSet)this.DataSet).DB.AddNewRowAndBases((DBDataSet)this.DataSet, dsPermission_1_0_0_1_To_1_0_4_13.Schema.T.User)));
			}
			protected override DataRow NewRowFromBuilder(DataRowBuilder builder) {
		...
		public class UserRow : DBIDataRow {
			...
			public IEnumerable<PermissionRow> GetPermissionUserIDChildRows() {
				return ((dsPermission_1_0_0_1_To_1_0_4_13)Table.DataSet).T.Permission.OfType<PermissionRow>().Where(r => Schema.T.User.F.Id.EffectiveType.GenericEquals(r.F.UserID, F.Id));
			}
		}
		#endregion
