...
namespace Thinkage.MainBoss.Database {
	...
	public class dsPermission_1_0_0_1_To_1_0_4_13 : XAFDataSet {
		...
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
		public dsPermission_1_0_0_1_To_1_0_4_13(XAFClient db) : base(Schema, db) {
			CommonCTOR();
		}
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
		...
		public class PermissionRow : DataRow {
			...
			public UserRow UserIDParentRow {
				get {
					return ((UserRow)(Path.T.Permission.F.UserID.GetParentRow(this)));
				}
			}
		...
		public class UserRow : DataRow {
			...
			public PermissionRow[] GetPermissionUserIDChildRows() {
				return ((PermissionRow[])(Path.T.Permission.F.UserID.GetChildRows(this)));
			}
		}
		#endregion
