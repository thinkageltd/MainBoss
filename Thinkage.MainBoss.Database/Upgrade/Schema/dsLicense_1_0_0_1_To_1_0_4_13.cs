...
namespace Thinkage.MainBoss.Database {
	...
	public class dsLicense_1_0_0_1_To_1_0_4_13 : DBDataSet {
		...
		public class VAccessor {
			...
			public VAccessor(dsLicense_1_0_0_1_To_1_0_4_13 this_dataset )
			{
			}
			#endregion
		}
		...
		public dsLicense_1_0_0_1_To_1_0_4_13() : base() {
			CommonCTOR();
		}
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
		public dsLicense_1_0_0_1_To_1_0_4_13(DBClient db) : base(Schema, db) {
			CommonCTOR();
		}
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
		public dsLicense_1_0_0_1_To_1_0_4_13(IServer server) : base(Schema, server) {
			CommonCTOR();
		}
#if SerializationSupport
		protected dsLicense_1_0_0_1_To_1_0_4_13(SerializationInfo info, StreamingContext context) {
		...
		protected override void InitClass() {
			this.DataSetName = "dsLicense_1_0_0_1_To_1_0_4_13";
			this.Prefix = "";
		...
		public class TAccessor {
			public TAccessor( dsLicense_1_0_0_1_To_1_0_4_13 this_dataset ) {
		...
		public class DTAccessor {
			public DTAccessor( dsLicense_1_0_0_1_To_1_0_4_13 this_dataset ) {
			}
		}
		#endregion
		...
		public class LicenseDataTable : DBICustomDataTable<LicenseRow> {
			...
			public LicenseRow AddNewRow() => (LicenseRow)DataSet.DB.AddNewRowAndBasesForGeneratedClass(DataSet, dsLicense_1_0_0_1_To_1_0_4_13.Schema.T.License);
			protected override DBIDataRow NewDBIRowFromBuilder(System.Data.DataRowBuilder builder) => new LicenseRow(builder);
			public new dsLicense_1_0_0_1_To_1_0_4_13 DataSet => (dsLicense_1_0_0_1_To_1_0_4_13)base.DataSet;
		}
		#region LicenseRow
		[Thinkage.Libraries.Translation.Invariant]
		...
		public class SchemaClass : DBI_Database {
			...
			private SchemaClass() {
				...
				CompleteDBI(System.Reflection.Assembly.GetExecutingAssembly(), "manifest://localhost/Thinkage/MainBoss/Database/Upgrade/Schema/dsLicense_1_0_0_1_To_1_0_4_13.xafdb", typeof(dsLicense_1_0_0_1_To_1_0_4_13)
				);
			 }
			/// <summary>
