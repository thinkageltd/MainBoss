...
namespace Thinkage.MainBoss.Database {
	...
	public class dsEmailRequest : DBDataSet {
		...
		#region RequestRow
		[Thinkage.Libraries.Translation.Invariant]
		public class RequestRow : DBIDataRow {
			public FAccessor F {
				get {
					if (_F == null)
						_F = new FAccessor(this);
			...
			public IEnumerable<EmailRequestRow> GetEmailRequestRequestIDChildRows() {
				return ((dsEmailRequest)Table.DataSet).T.EmailRequest.OfType<EmailRequestRow>().Where(r => Schema.T.Request.F.Id.EffectiveType.GenericEquals(r.F.RequestID, F.Id));
			}
		}
		#endregion
		...
		[Thinkage.Libraries.Translation.Invariant]
		public class EmailRequestRow : DBIDataRow {
			public FAccessor F {
				get {
					if (_F == null)
						_F = new FAccessor(this);
			...
			public RequestRow RequestIDParentRow {
				get {
					return ((dsEmailRequest)Table.DataSet).T.Request.RowFind<RequestRow>(F.RequestID);
				}
			}

			public IEnumerable<EmailPartRow> GetEmailPartEmailRequestIDChildRows() {
				return ((dsEmailRequest)Table.DataSet).T.EmailPart.OfType<EmailPartRow>().Where(r => Schema.T.EmailRequest.F.Id.EffectiveType.GenericEquals(r.F.EmailRequestID, F.Id));
			}
		}
		#endregion
		...
		#region EmailPartRow
		[Thinkage.Libraries.Translation.Invariant]
		public class EmailPartRow : DBIDataRow {
			public FAccessor F {
				get {
					if (_F == null)
						_F = new FAccessor(this);
			...
			public EmailPartRow ParentIDParentRow {
				get {
					return ((dsEmailRequest)Table.DataSet).T.EmailPart.RowFind<EmailPartRow>(F.ParentID);
				}
			}

			public EmailRequestRow EmailRequestIDParentRow {
				get {
					return ((dsEmailRequest)Table.DataSet).T.EmailRequest.RowFind<EmailRequestRow>(F.EmailRequestID);
				}
			}

			public IEnumerable<EmailPartRow> GetEmailPartParentIDChildRows() {
				return ((dsEmailRequest)Table.DataSet).T.EmailPart.OfType<EmailPartRow>().Where(r => Schema.T.EmailPart.F.Id.EffectiveType.GenericEquals(r.F.ParentID, F.Id));
			}
		}
		#endregion
