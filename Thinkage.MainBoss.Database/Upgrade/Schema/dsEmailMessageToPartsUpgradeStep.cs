...
namespace Thinkage.MainBoss.Database {
	...
	public class dsEmailRequest : DBDataSet {
		...
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
		public dsEmailRequest(DBClient db) : base(Schema, db) {
			CommonCTOR();
		}
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
		...
		protected dsEmailRequest(SerializationInfo info, StreamingContext context) {
			...
			if ((strSchema != null)) {
				...
				if ((ds.Tables.FindTableDuringTableConstruction(SchemaClass.Instance.T.Request) != null)) {
					this.Tables.Add(new RequestDataTable(ds.Tables.FindTableDuringTableConstruction(SchemaClass.Instance.T.Request)));
				}
				if ((ds.Tables.FindTableDuringTableConstruction(SchemaClass.Instance.T.EmailRequest) != null)) {
					this.Tables.Add(new EmailRequestDataTable(ds.Tables.FindTableDuringTableConstruction(SchemaClass.Instance.T.EmailRequest)));
				}
				if ((ds.Tables.FindTableDuringTableConstruction(SchemaClass.Instance.T.EmailPart) != null)) {
					this.Tables.Add(new EmailPartDataTable(ds.Tables.FindTableDuringTableConstruction(SchemaClass.Instance.T.EmailPart)));
				}
		...
		public class TAccessor {
			public TAccessor( dsEmailRequest this_dataset ) {
				this.Request = (RequestDataTable)this_dataset.Tables.FindTableDuringTableConstruction(SchemaClass.Instance.T.Request);
				this.EmailRequest = (EmailRequestDataTable)this_dataset.Tables.FindTableDuringTableConstruction(SchemaClass.Instance.T.EmailRequest);
				this.EmailPart = (EmailPartDataTable)this_dataset.Tables.FindTableDuringTableConstruction(SchemaClass.Instance.T.EmailPart);
			}
		...
		public class DTAccessor {
			public DTAccessor( dsEmailRequest this_dataset ) {
				this.EmailRequest = (EmailRequestDataTable)this_dataset.Tables.FindTableDuringTableConstruction(SchemaClass.Instance.T.EmailRequest.Default);
			}
			public readonly EmailRequestDataTable EmailRequest;
		}
		#endregion
		...
		[Thinkage.Libraries.Translation.Invariant]
		public class RequestDataTable : DBICustomDataTable<RequestRow> {
			#region Construction
...
#if SerializationSupport
			internal RequestDataTable(System.Data.DataTable table) :
			...
			internal class FAccessor {
				public FAccessor(RequestDataTable t) {
				  this.Id = t.Columns.FindColumnDuringTableConstruction(SchemaClass.Instance.T.Request.F.Id);
				}
				/// <summary>
			...
			protected override void OnRowChanged(DataRowChangeEventArgs e) {
				base.OnRowChanged(e);
				this.RequestRowChanged?.Invoke(this, new RequestRowChangeEvent(((RequestRow)(e.Row)), e.Action));
			}
			protected override void OnRowChanging(DataRowChangeEventArgs e) {
				base.OnRowChanging(e);
				this.RequestRowChanging?.Invoke(this, new RequestRowChangeEvent(((RequestRow)(e.Row)), e.Action));
			}
			protected override void OnRowDeleted(DataRowChangeEventArgs e) {
				base.OnRowDeleted(e);
				this.RequestRowDeleted?.Invoke(this, new RequestRowChangeEvent(((RequestRow)(e.Row)), e.Action));
			}
			protected override void OnRowDeleting(DataRowChangeEventArgs e) {
				base.OnRowDeleting(e);
				this.RequestRowDeleting?.Invoke(this, new RequestRowChangeEvent(((RequestRow)(e.Row)), e.Action));
			}
			#endif
			#endregion
			protected override DBIDataTable CreateDBIInstance() => new RequestDataTable(Schema, Server);
			public RequestRow AddNewRow() => (RequestRow)DataSet.DB.AddNewRowAndBasesForGeneratedClass(DataSet, dsEmailRequest.Schema.T.Request);
			protected override DBIDataRow NewDBIRowFromBuilder(System.Data.DataRowBuilder builder) => new RequestRow(builder);
			public new dsEmailRequest DataSet => (dsEmailRequest)base.DataSet;
		}
		#region RequestRow
		[Thinkage.Libraries.Translation.Invariant]
		public class RequestRow : DBICustomDataRow<RequestDataTable> {
			#region Construction
			internal RequestRow(System.Data.DataRowBuilder rb)
				: base(rb) {
			}
			#endregion
			#region Typed Column accessor
			...
			public IEnumerable<EmailRequestRow> GetEmailRequestRequestIDChildRows() => Table.DataSet.T.EmailRequest.Rows.Where(r => Schema.T.Request.F.Id.EffectiveType.GenericEquals(r.F.RequestID, F.Id));
			#endregion
		}
		#endregion
		...
		[Thinkage.Libraries.Translation.Invariant]
		public class EmailRequestDataTable : DBICustomDataTable<EmailRequestRow> {
			#region Construction
...
#if SerializationSupport
			internal EmailRequestDataTable(System.Data.DataTable table) :
					base(table.TableName) {
				if ((table.CaseSensitive != table.DataSet.CaseSensitive)) {
					this.CaseSensitive = table.CaseSensitive;
				}
			...
			internal class FAccessor {
				public FAccessor(EmailRequestDataTable t) {
				  this.Id = t.Columns.FindColumnDuringTableConstruction(SchemaClass.Instance.T.EmailRequest.F.Id);
				  this.FromEmailAddress = t.Columns.FindColumnDuringTableConstruction(SchemaClass.Instance.T.EmailRequest.F.FromEmailAddress);
				  this.RequestorEmailAddress = t.Columns.FindColumnDuringTableConstruction(SchemaClass.Instance.T.EmailRequest.F.RequestorEmailAddress);
				  this.RequestorEmailDisplayName = t.Columns.FindColumnDuringTableConstruction(SchemaClass.Instance.T.EmailRequest.F.RequestorEmailDisplayName);
				  this.ProcessingState = t.Columns.FindColumnDuringTableConstruction(SchemaClass.Instance.T.EmailRequest.F.ProcessingState);
				  this.Comment = t.Columns.FindColumnDuringTableConstruction(SchemaClass.Instance.T.EmailRequest.F.Comment);
				  this.ReceiveDate = t.Columns.FindColumnDuringTableConstruction(SchemaClass.Instance.T.EmailRequest.F.ReceiveDate);
				  this.MailHeader = t.Columns.FindColumnDuringTableConstruction(SchemaClass.Instance.T.EmailRequest.F.MailHeader);
				  this.MailMessage = t.Columns.FindColumnDuringTableConstruction(SchemaClass.Instance.T.EmailRequest.F.MailMessage);
				  this.RequestID = t.Columns.FindColumnDuringTableConstruction(SchemaClass.Instance.T.EmailRequest.F.RequestID);
				  this.PreferredLanguage = t.Columns.FindColumnDuringTableConstruction(SchemaClass.Instance.T.EmailRequest.F.PreferredLanguage);
				}
				/// <summary>
			...
			protected override void OnRowChanged(DataRowChangeEventArgs e) {
				base.OnRowChanged(e);
				this.EmailRequestRowChanged?.Invoke(this, new EmailRequestRowChangeEvent(((EmailRequestRow)(e.Row)), e.Action));
			}
			protected override void OnRowChanging(DataRowChangeEventArgs e) {
				base.OnRowChanging(e);
				this.EmailRequestRowChanging?.Invoke(this, new EmailRequestRowChangeEvent(((EmailRequestRow)(e.Row)), e.Action));
			}
			protected override void OnRowDeleted(DataRowChangeEventArgs e) {
				base.OnRowDeleted(e);
				this.EmailRequestRowDeleted?.Invoke(this, new EmailRequestRowChangeEvent(((EmailRequestRow)(e.Row)), e.Action));
			}
			protected override void OnRowDeleting(DataRowChangeEventArgs e) {
				base.OnRowDeleting(e);
				this.EmailRequestRowDeleting?.Invoke(this, new EmailRequestRowChangeEvent(((EmailRequestRow)(e.Row)), e.Action));
			}
			#endif
			#endregion
			protected override DBIDataTable CreateDBIInstance() => new EmailRequestDataTable(Schema, Server);
			public EmailRequestRow AddNewRow() => (EmailRequestRow)DataSet.DB.AddNewRowAndBasesForGeneratedClass(DataSet, dsEmailRequest.Schema.T.EmailRequest);
			protected override DBIDataRow NewDBIRowFromBuilder(System.Data.DataRowBuilder builder) => new EmailRequestRow(builder);
			public new dsEmailRequest DataSet => (dsEmailRequest)base.DataSet;
		}
		#region EmailRequestRow
		[Thinkage.Libraries.Translation.Invariant]
		public class EmailRequestRow : DBICustomDataRow<EmailRequestDataTable> {
			#region Construction
			internal EmailRequestRow(System.Data.DataRowBuilder rb)
				: base(rb) {
			}
			#endregion
			#region Typed Column accessor
			...
			#endregion
			#region Referenced-record accessors
			public RequestRow RequestIDParentRow => Table.DataSet.T.Request.Rows.Find(F.RequestID);
			#endregion
			#region Referring-record accessors
			public IEnumerable<EmailPartRow> GetEmailPartEmailRequestIDChildRows() => Table.DataSet.T.EmailPart.Rows.Where(r => Schema.T.EmailRequest.F.Id.EffectiveType.GenericEquals(r.F.EmailRequestID, F.Id));
			#endregion
		}
		#endregion
		...
		[Thinkage.Libraries.Translation.Invariant]
		public class EmailPartDataTable : DBICustomDataTable<EmailPartRow> {
			#region Construction
...
#if SerializationSupport
			internal EmailPartDataTable(System.Data.DataTable table) :
					base(table.TableName) {
				if ((table.CaseSensitive != table.DataSet.CaseSensitive)) {
					this.CaseSensitive = table.CaseSensitive;
				}
			...
			internal class FAccessor {
				public FAccessor(EmailPartDataTable t) {
				  this.Id = t.Columns.FindColumnDuringTableConstruction(SchemaClass.Instance.T.EmailPart.F.Id);
				  this.ParentID = t.Columns.FindColumnDuringTableConstruction(SchemaClass.Instance.T.EmailPart.F.ParentID);
				  this.EmailRequestID = t.Columns.FindColumnDuringTableConstruction(SchemaClass.Instance.T.EmailPart.F.EmailRequestID);
				  this.ContentType = t.Columns.FindColumnDuringTableConstruction(SchemaClass.Instance.T.EmailPart.F.ContentType);
				  this.Header = t.Columns.FindColumnDuringTableConstruction(SchemaClass.Instance.T.EmailPart.F.Header);
				  this.ContentLength = t.Columns.FindColumnDuringTableConstruction(SchemaClass.Instance.T.EmailPart.F.ContentLength);
				  this.Name = t.Columns.FindColumnDuringTableConstruction(SchemaClass.Instance.T.EmailPart.F.Name);
				  this.Order = t.Columns.FindColumnDuringTableConstruction(SchemaClass.Instance.T.EmailPart.F.Order);
				  this.Content = t.Columns.FindColumnDuringTableConstruction(SchemaClass.Instance.T.EmailPart.F.Content);
				}
				/// <summary>
			...
			protected override void OnRowChanged(DataRowChangeEventArgs e) {
				base.OnRowChanged(e);
				this.EmailPartRowChanged?.Invoke(this, new EmailPartRowChangeEvent(((EmailPartRow)(e.Row)), e.Action));
			}
			protected override void OnRowChanging(DataRowChangeEventArgs e) {
				base.OnRowChanging(e);
				this.EmailPartRowChanging?.Invoke(this, new EmailPartRowChangeEvent(((EmailPartRow)(e.Row)), e.Action));
			}
			protected override void OnRowDeleted(DataRowChangeEventArgs e) {
				base.OnRowDeleted(e);
				this.EmailPartRowDeleted?.Invoke(this, new EmailPartRowChangeEvent(((EmailPartRow)(e.Row)), e.Action));
			}
			protected override void OnRowDeleting(DataRowChangeEventArgs e) {
				base.OnRowDeleting(e);
				this.EmailPartRowDeleting?.Invoke(this, new EmailPartRowChangeEvent(((EmailPartRow)(e.Row)), e.Action));
			}
			#endif
			#endregion
			protected override DBIDataTable CreateDBIInstance() => new EmailPartDataTable(Schema, Server);
			public EmailPartRow AddNewRow() => (EmailPartRow)DataSet.DB.AddNewRowAndBasesForGeneratedClass(DataSet, dsEmailRequest.Schema.T.EmailPart);
			protected override DBIDataRow NewDBIRowFromBuilder(System.Data.DataRowBuilder builder) => new EmailPartRow(builder);
			public new dsEmailRequest DataSet => (dsEmailRequest)base.DataSet;
		}
		#region EmailPartRow
		[Thinkage.Libraries.Translation.Invariant]
		public class EmailPartRow : DBICustomDataRow<EmailPartDataTable> {
			#region Construction
			internal EmailPartRow(System.Data.DataRowBuilder rb)
				: base(rb) {
			}
			#endregion
			#region Typed Column accessor
			...
			#endregion
			#region Referenced-record accessors
			public EmailPartRow ParentIDParentRow => Table.DataSet.T.EmailPart.Rows.Find(F.ParentID);
			public EmailRequestRow EmailRequestIDParentRow => Table.DataSet.T.EmailRequest.Rows.Find(F.EmailRequestID);
			#endregion
			#region Referring-record accessors
			public IEnumerable<EmailPartRow> GetEmailPartParentIDChildRows() => Table.DataSet.T.EmailPart.Rows.Where(r => Schema.T.EmailPart.F.Id.EffectiveType.GenericEquals(r.F.ParentID, F.Id));
			#endregion
		}
		#endregion
		...
		public class SchemaClass : DBI_Database {
			...
			/// </summary>
			public class DBI_Request : DBIDataDBI_Table {
				public FAccessor F;
				...
				internal DBI_Request()
					: base("Request", (DBI_Table tableSchema, IServer s) => new RequestDataTable(tableSchema, s)) {
				}
			...
			/// </summary>
			public class DBI_EmailRequest : DBIDataDBI_Table {
				public FAccessor F;
				private DBI_Column __Id;
				...
				internal DBI_EmailRequest()
					: base("EmailRequest", (DBI_Table tableSchema, IServer s) => new EmailRequestDataTable(tableSchema, s)) {
				}
			...
			/// </summary>
			public class DBI_EmailPart : DBIDataDBI_Table {
				public FAccessor F;
				private DBI_Column __Id;
				...
				internal DBI_EmailPart()
					: base("EmailPart", (DBI_Table tableSchema, IServer s) => new EmailPartDataTable(tableSchema, s)) {
				}
