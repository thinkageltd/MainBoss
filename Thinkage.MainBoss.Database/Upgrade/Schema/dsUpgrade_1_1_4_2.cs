	...
	public class dsUpgrade_1_1_4_2 : DBDataSet {
		...
		public class PermissionRow : DBIDataRow {
			...
			public PrincipalRow PrincipalIDParentRow {
				get {
					return ((dsUpgrade_1_1_4_2)Table.DataSet).T.Principal.RowFind<PrincipalRow>(F.PrincipalID);
				}
			}
		...
		public class PrincipalRow : DBIDataRow {
			...
			public RoleRow RoleIDParentRow {
				get {
					return ((dsUpgrade_1_1_4_2)Table.DataSet).T.Role.RowFind<RoleRow>(F.RoleID);
				}
			}

			public UserRow UserIDParentRow {
				get {
					return ((dsUpgrade_1_1_4_2)Table.DataSet).T.User.RowFind<UserRow>(F.UserID);
				}
			}

			public IEnumerable<PermissionRow> GetPermissionPrincipalIDChildRows() {
				return ((dsUpgrade_1_1_4_2)Table.DataSet).T.Permission.OfType<PermissionRow>().Where(r => Schema.T.Principal.F.Id.EffectiveType.GenericEquals(r.F.PrincipalID, F.Id));
			}
			public IEnumerable<RoleRow> GetRolePrincipalIDChildRows() {
				return ((dsUpgrade_1_1_4_2)Table.DataSet).T.Role.OfType<RoleRow>().Where(r => Schema.T.Principal.F.Id.EffectiveType.GenericEquals(r.F.PrincipalID, F.Id));
			}
			public IEnumerable<UserRow> GetUserPrincipalIDChildRows() {
				return ((dsUpgrade_1_1_4_2)Table.DataSet).T.User.OfType<UserRow>().Where(r => Schema.T.Principal.F.Id.EffectiveType.GenericEquals(r.F.PrincipalID, F.Id));
			}
			public IEnumerable<UserRoleRow> GetUserRolePrincipalIDChildRows() {
				return ((dsUpgrade_1_1_4_2)Table.DataSet).T.UserRole.OfType<UserRoleRow>().Where(r => Schema.T.Principal.F.Id.EffectiveType.GenericEquals(r.F.PrincipalID, F.Id));
			}
		}
		#endregion
		...
		public class RoleRow : DBIDataRow {
			...
			public IEnumerable<PrincipalRow> GetPrincipalRoleIDChildRows() {
				return ((dsUpgrade_1_1_4_2)Table.DataSet).T.Principal.OfType<PrincipalRow>().Where(r => Schema.T.Role.F.Id.EffectiveType.GenericEquals(r.F.RoleID, F.Id));
			}
		}
		#endregion
		...
		public class UserRow : DBIDataRow {
			...
			public IEnumerable<UserRoleRow> GetUserRoleUserIDChildRows() {
				return ((dsUpgrade_1_1_4_2)Table.DataSet).T.UserRole.OfType<UserRoleRow>().Where(r => Schema.T.User.F.Id.EffectiveType.GenericEquals(r.F.UserID, F.Id));
			}
			public IEnumerable<UserPermissionRow> GetUserPermissionUserIDChildRows() {
				return ((dsUpgrade_1_1_4_2)Table.DataSet).T.UserPermission.OfType<UserPermissionRow>().Where(r => Schema.T.User.F.Id.EffectiveType.GenericEquals(r.F.UserID, F.Id));
			}
			public IEnumerable<PrincipalRow> GetPrincipalUserIDChildRows() {
				return ((dsUpgrade_1_1_4_2)Table.DataSet).T.Principal.OfType<PrincipalRow>().Where(r => Schema.T.User.F.Id.EffectiveType.GenericEquals(r.F.UserID, F.Id));
			}
		}
		#endregion
		...
		[Thinkage.Libraries.Translation.Invariant]
		public class BackupFileNameRow : DBIDataRow {
			public FAccessor F {
				get {
					if (_F == null)
						_F = new FAccessor(this);
