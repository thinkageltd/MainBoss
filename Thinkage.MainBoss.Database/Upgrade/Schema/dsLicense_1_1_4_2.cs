...
namespace Thinkage.MainBoss.Database {
	...
	public class dsLicense_1_1_4_2 : DBDataSet {
		...
		public class VAccessor {
			...
			public VAccessor(dsLicense_1_1_4_2 this_dataset )
			{
			}
			#endregion
		}
		...
		public dsLicense_1_1_4_2() : base() {
			CommonCTOR();
		}
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
		public dsLicense_1_1_4_2(DBClient db) : base(Schema, db) {
			CommonCTOR();
		}
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
		public dsLicense_1_1_4_2(IServer server) : base(Schema, server) {
			CommonCTOR();
		}
#if SerializationSupport
		protected dsLicense_1_1_4_2(SerializationInfo info, StreamingContext context) {
		...
		protected override void InitClass() {
			this.DataSetName = "dsLicense_1_1_4_2";
			this.Prefix = "";
		...
		public class TAccessor {
			public TAccessor( dsLicense_1_1_4_2 this_dataset ) {
		...
		public class DTAccessor {
			public DTAccessor( dsLicense_1_1_4_2 this_dataset ) {
			}
		}
		#endregion
		...
		public class LicenseDataTable : DBICustomDataTable<LicenseRow> {
			...
			public LicenseRow AddNewRow() => (LicenseRow)DataSet.DB.AddNewRowAndBasesForGeneratedClass(DataSet, dsLicense_1_1_4_2.Schema.T.License);
			protected override DBIDataRow NewDBIRowFromBuilder(System.Data.DataRowBuilder builder) => new LicenseRow(builder);
			public new dsLicense_1_1_4_2 DataSet => (dsLicense_1_1_4_2)base.DataSet;
		}
		#region LicenseRow
		[Thinkage.Libraries.Translation.Invariant]
		...
		public class SchemaClass : DBI_Database {
			...
			private SchemaClass() {
				...
				CompleteDBI(System.Reflection.Assembly.GetExecutingAssembly(), "manifest://localhost/Thinkage/MainBoss/Database/Upgrade/Schema/dsLicense_1_1_4_2.xafdb", typeof(dsLicense_1_1_4_2)
				);
			 }
			/// <summary>
	...
	#region LabelKeys
	#if DEFINELABELKEYS
	internal static class dsLicense_1_1_4_2DefineKeysFordsMBLabel {
		static private Thinkage.Libraries.Translation.Key License = dsLicense_1_1_4_2.LabelKeyBuilder.K("License");
		static private Thinkage.Libraries.Translation.Key License_Id = dsLicense_1_1_4_2.LabelKeyBuilder.K("Id");
		static private Thinkage.Libraries.Translation.Key License_License = dsLicense_1_1_4_2.LabelKeyBuilder.K("License");
		static private Thinkage.Libraries.Translation.Key License_ApplicationID = dsLicense_1_1_4_2.LabelKeyBuilder.K("Application");
		static private Thinkage.Libraries.Translation.Key License_Expiry = dsLicense_1_1_4_2.LabelKeyBuilder.K("Expiry");
		static private Thinkage.Libraries.Translation.Key License_ExpiryModel = dsLicense_1_1_4_2.LabelKeyBuilder.K("ExpiryModel");
		static private Thinkage.Libraries.Translation.Key License_LicenseCount = dsLicense_1_1_4_2.LabelKeyBuilder.K("LicenseCount");
		static private Thinkage.Libraries.Translation.Key License_LicenseModel = dsLicense_1_1_4_2.LabelKeyBuilder.K("LicenseModel");
		static private Thinkage.Libraries.Translation.Key License_LicenseID = dsLicense_1_1_4_2.LabelKeyBuilder.K("License Id");
	}
	#endif
	#endregion
}
