...
namespace Thinkage.MainBoss.Database {
	...
	public class dsDBVersion_1_0_0_1_To_1_0_8_1 : DBDataSet {
		...
		public class VAccessor {
			...
			public VAccessor(dsDBVersion_1_0_0_1_To_1_0_8_1 this_dataset )
			{
		...
		public dsDBVersion_1_0_0_1_To_1_0_8_1() : base() {
			CommonCTOR();
		}
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
		public dsDBVersion_1_0_0_1_To_1_0_8_1(DBClient db) : base(Schema, db) {
			CommonCTOR();
		}
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
		public dsDBVersion_1_0_0_1_To_1_0_8_1(IServer server) : base(Schema, server) {
			CommonCTOR();
		}
#if SerializationSupport
		protected dsDBVersion_1_0_0_1_To_1_0_8_1(SerializationInfo info, StreamingContext context) {
		...
		protected override void InitClass() {
			this.DataSetName = "dsDBVersion_1_0_0_1_To_1_0_8_1";
			this.Prefix = "";
		...
		public class TAccessor {
			public TAccessor( dsDBVersion_1_0_0_1_To_1_0_8_1 this_dataset ) {
			}
		}
		#endregion
		...
		public class DTAccessor {
			public DTAccessor( dsDBVersion_1_0_0_1_To_1_0_8_1 this_dataset ) {
			}
		}
		#endregion
		...
		public class SchemaClass : DBI_Database {
			...
			private SchemaClass() {
				...
				CompleteDBI(System.Reflection.Assembly.GetExecutingAssembly(), "manifest://localhost/Thinkage/MainBoss/Database/Upgrade/Schema/dsDBVersion_1_0_0_1_To_1_0_8_1.xafdb", typeof(dsDBVersion_1_0_0_1_To_1_0_8_1));
