...
namespace Thinkage.MainBoss.Database {
	...
	public class dsLicense_1_0_10_3 : DBDataSet {
		...
		public class LicenseDataTable : DBICustomDataTable<LicenseRow> {
			...
			public LicenseRow AddNewRow() => (LicenseRow)DataSet.DB.AddNewRowAndBasesForGeneratedClass(DataSet, dsLicense_1_0_10_3.Schema.T.License);
			protected override DBIDataRow NewDBIRowFromBuilder(System.Data.DataRowBuilder builder) => new LicenseRow(builder);
			public new dsLicense_1_0_10_3 DataSet => (dsLicense_1_0_10_3)base.DataSet;
		}
		#region LicenseRow
		[Thinkage.Libraries.Translation.Invariant]
