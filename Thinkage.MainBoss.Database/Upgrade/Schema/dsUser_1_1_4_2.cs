...
namespace Thinkage.MainBoss.Database {
	...
	public class dsUser_1_1_4_2 : DBDataSet {
		...
		public class UserDataTable : DBICustomDataTable<UserRow> {
			...
			public UserRow AddNewRow() => (UserRow)DataSet.DB.AddNewRowAndBasesForGeneratedClass(DataSet, dsUser_1_1_4_2.Schema.T.User);
			protected override DBIDataRow NewDBIRowFromBuilder(System.Data.DataRowBuilder builder) => new UserRow(builder);
			public new dsUser_1_1_4_2 DataSet => (dsUser_1_1_4_2)base.DataSet;
		}
		#region UserRow
		[Thinkage.Libraries.Translation.Invariant]
		...
		public class PrincipalDataTable : DBICustomDataTable<PrincipalRow> {
			...
			public PrincipalRow AddNewRow() => (PrincipalRow)DataSet.DB.AddNewRowAndBasesForGeneratedClass(DataSet, dsUser_1_1_4_2.Schema.T.Principal);
