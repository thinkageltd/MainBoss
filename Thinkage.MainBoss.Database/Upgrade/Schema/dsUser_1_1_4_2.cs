...
namespace Thinkage.MainBoss.Database {
	...
	public class dsUser_1_1_4_2 : DBDataSet {
		...
		public class VAccessor {
			...
			public VAccessor(dsUser_1_1_4_2 this_dataset )
			{
			}
			#endregion
		}
		...
		public dsUser_1_1_4_2() : base() {
			CommonCTOR();
		}
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
		public dsUser_1_1_4_2(DBClient db) : base(Schema, db) {
			CommonCTOR();
		}
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
		public dsUser_1_1_4_2(IServer server) : base(Schema, server) {
			CommonCTOR();
		}
#if SerializationSupport
		protected dsUser_1_1_4_2(SerializationInfo info, StreamingContext context) {
		...
		protected override void InitClass() {
			this.DataSetName = "dsUser_1_1_4_2";
			this.Prefix = "";
		...
		public class TAccessor {
			public TAccessor( dsUser_1_1_4_2 this_dataset ) {
		...
		public class DTAccessor {
			public DTAccessor( dsUser_1_1_4_2 this_dataset ) {
		...
		public class UserDataTable : DBIDataTable {
			...
			public UserRow AddNewUserRow() {
				return ((UserRow)(((DBDataSet)this.DataSet).DB.AddNewRowAndBases((DBDataSet)this.DataSet, dsUser_1_1_4_2.Schema.T.User)));
			}
		...
		public class UserRow : DBIDataRow {
			...
			public PrincipalRow PrincipalIDParentRow {
				get {
					return ((dsUser_1_1_4_2)Table.DataSet).T.Principal.RowFind<PrincipalRow>(F.PrincipalID);
				}
			}

			public IEnumerable<PrincipalRow> GetPrincipalUserIDChildRows() {
				return ((dsUser_1_1_4_2)Table.DataSet).T.Principal.OfType<PrincipalRow>().Where(r => Schema.T.User.F.Id.EffectiveType.GenericEquals(r.F.UserID, F.Id));
			}
		}
		#endregion
		...
		public class PrincipalDataTable : DBIDataTable {
			...
			public PrincipalRow AddNewPrincipalRow() {
				return ((PrincipalRow)(((DBDataSet)this.DataSet).DB.AddNewRowAndBases((DBDataSet)this.DataSet, dsUser_1_1_4_2.Schema.T.Principal)));
			}
			protected override DataRow NewRowFromBuilder(DataRowBuilder builder) {
		...
		public class PrincipalRow : DBIDataRow {
			...
			public UserRow UserIDParentRow {
				get {
					return ((dsUser_1_1_4_2)Table.DataSet).T.User.RowFind<UserRow>(F.UserID);
				}
			}

			public IEnumerable<UserRow> GetUserPrincipalIDChildRows() {
				return ((dsUser_1_1_4_2)Table.DataSet).T.User.OfType<UserRow>().Where(r => Schema.T.Principal.F.Id.EffectiveType.GenericEquals(r.F.PrincipalID, F.Id));
			}
		}
		#endregion
		...
		public class SchemaClass : DBI_Database {
			...
			private SchemaClass() {
				...
				CompleteDBI(System.Reflection.Assembly.GetExecutingAssembly(), "manifest://localhost/Thinkage/MainBoss/Database/Upgrade/Schema/dsUser_1_1_4_2.xafdb", typeof(dsUser_1_1_4_2));
			 }
			/// <summary>
