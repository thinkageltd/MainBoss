...
namespace Thinkage.MainBoss.Database {
	...
	public class dsPermission_1_0_4_14_To_1_0_10_15 : DBDataSet {
		...
		public class PermissionDataTable : DBICustomDataTable<PermissionRow> {
			...
			public PermissionRow AddNewRow() => (PermissionRow)DataSet.DB.AddNewRowAndBasesForGeneratedClass(DataSet, dsPermission_1_0_4_14_To_1_0_10_15.Schema.T.Permission);
			protected override DBIDataRow NewDBIRowFromBuilder(System.Data.DataRowBuilder builder) => new PermissionRow(builder);
			public new dsPermission_1_0_4_14_To_1_0_10_15 DataSet => (dsPermission_1_0_4_14_To_1_0_10_15)base.DataSet;
		}
		...
		public class PrincipalDataTable : DBICustomDataTable<PrincipalRow> {
			...
			internal class FAccessor {
				public FAccessor(PrincipalDataTable t) {
				  ...
				  this.Desc = t.Columns.FindColumnDuringTableConstruction(SchemaClass.Instance.T.Principal.F.Desc);
				  this.Comment = t.Columns.FindColumnDuringTableConstruction(SchemaClass.Instance.T.Principal.F.Comment);
			...
			public PrincipalRow AddNewRow() => (PrincipalRow)DataSet.DB.AddNewRowAndBasesForGeneratedClass(DataSet, dsPermission_1_0_4_14_To_1_0_10_15.Schema.T.Principal);
		...
		public class RoleDataTable : DBICustomDataTable<RoleRow> {
			...
			public RoleRow AddNewRow() => (RoleRow)DataSet.DB.AddNewRowAndBasesForGeneratedClass(DataSet, dsPermission_1_0_4_14_To_1_0_10_15.Schema.T.Role);
		...
		public class UserDataTable : DBICustomDataTable<UserRow> {
			...
			public UserRow AddNewRow() => (UserRow)DataSet.DB.AddNewRowAndBasesForGeneratedClass(DataSet, dsPermission_1_0_4_14_To_1_0_10_15.Schema.T.User);
		...
		public class UserPermissionDataTable : DBICustomDataTable<UserPermissionRow> {
			...
			public UserPermissionRow AddNewRow() => (UserPermissionRow)DataSet.DB.AddNewRowAndBasesForGeneratedClass(DataSet, dsPermission_1_0_4_14_To_1_0_10_15.Schema.T.UserPermission);
		...
		public class UserRoleDataTable : DBICustomDataTable<UserRoleRow> {
			...
			public UserRoleRow AddNewRow() => (UserRoleRow)DataSet.DB.AddNewRowAndBasesForGeneratedClass(DataSet, dsPermission_1_0_4_14_To_1_0_10_15.Schema.T.UserRole);
