...
namespace Thinkage.MainBoss.Database {
	...
	public class dsPermission_1_0_4_14_To_1_0_10_15 : DBDataSet {
		...
		public class VAccessor {
			...
			public VAccessor(dsPermission_1_0_4_14_To_1_0_10_15 this_dataset )
			{
			}
			#endregion
		}
		...
		public dsPermission_1_0_4_14_To_1_0_10_15() : base() {
			CommonCTOR();
		}
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
		public dsPermission_1_0_4_14_To_1_0_10_15(DBClient db) : base(Schema, db) {
			CommonCTOR();
		}
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
		public dsPermission_1_0_4_14_To_1_0_10_15(IServer server) : base(Schema, server) {
			CommonCTOR();
		}
#if SerializationSupport
		protected dsPermission_1_0_4_14_To_1_0_10_15(SerializationInfo info, StreamingContext context) {
		...
		protected override void InitClass() {
			this.DataSetName = "dsPermission_1_0_4_14_To_1_0_10_15";
			this.Prefix = "";
		...
		public class TAccessor {
			public TAccessor( dsPermission_1_0_4_14_To_1_0_10_15 this_dataset ) {
		...
		public class DTAccessor {
			public DTAccessor( dsPermission_1_0_4_14_To_1_0_10_15 this_dataset ) {
		...
		public class PermissionDataTable : DBIDataTable {
			...
			public PermissionRow AddNewPermissionRow() {
				return ((PermissionRow)(((DBDataSet)this.DataSet).DB.AddNewRowAndBases((DBDataSet)this.DataSet, dsPermission_1_0_4_14_To_1_0_10_15.Schema.T.Permission)));
			}
		...
		public class PermissionRow : DBIDataRow {
			...
			public PrincipalRow PrincipalIDParentRow {
				get {
					return ((dsPermission_1_0_4_14_To_1_0_10_15)Table.DataSet).T.Principal.RowFind<PrincipalRow>(F.PrincipalID);
				}
			}
		...
		public class PrincipalDataTable : DBIDataTable {
			...
			internal class FAccessor {
				...
				public readonly DBIDataColumn Id;
				/// <summary>
				/// Denotes the Principal's Desc column with type string(minlength 1, maxlength 150, maxlines 0, trim) with labelkey='Desc'
				/// </summary>
				public readonly DBIDataColumn Desc;
				/// <summary>
				/// Denotes the Principal's Comment column with type string(minlength 1, (maxlength 1,073,741,823), trim) with labelkey='Comment'
				/// </summary>
			...
			public PrincipalRow AddNewPrincipalRow() {
				return ((PrincipalRow)(((DBDataSet)this.DataSet).DB.AddNewRowAndBases((DBDataSet)this.DataSet, dsPermission_1_0_4_14_To_1_0_10_15.Schema.T.Principal)));
			}
			protected override DataRow NewRowFromBuilder(DataRowBuilder builder) {
		...
		public class PrincipalRow : DBIDataRow {
			...
			public class FAccessor {
				...
				public System.String Desc {
					get {
							return (System.String)Schema.T.Principal.F.Desc.EffectiveType.GenericAsNativeType(this_table.F.Desc[this_row], typeof(System.String));
					}
				...
				public System.String Comment {
					get {
							return (System.String)Schema.T.Principal.F.Comment.EffectiveType.GenericAsNativeType(this_table.F.Comment[this_row], typeof(System.String));
					}
			...
			public RoleRow RoleIDParentRow {
				get {
					return ((dsPermission_1_0_4_14_To_1_0_10_15)Table.DataSet).T.Role.RowFind<RoleRow>(F.RoleID);
				}
			}

			public UserRow UserIDParentRow {
				get {
					return ((dsPermission_1_0_4_14_To_1_0_10_15)Table.DataSet).T.User.RowFind<UserRow>(F.UserID);
				}
			}

			public IEnumerable<PermissionRow> GetPermissionPrincipalIDChildRows() {
				return ((dsPermission_1_0_4_14_To_1_0_10_15)Table.DataSet).T.Permission.OfType<PermissionRow>().Where(r => Schema.T.Principal.F.Id.EffectiveType.GenericEquals(r.F.PrincipalID, F.Id));
			}
			public IEnumerable<RoleRow> GetRolePrincipalIDChildRows() {
				return ((dsPermission_1_0_4_14_To_1_0_10_15)Table.DataSet).T.Role.OfType<RoleRow>().Where(r => Schema.T.Principal.F.Id.EffectiveType.GenericEquals(r.F.PrincipalID, F.Id));
			}
			public IEnumerable<UserRow> GetUserPrincipalIDChildRows() {
				return ((dsPermission_1_0_4_14_To_1_0_10_15)Table.DataSet).T.User.OfType<UserRow>().Where(r => Schema.T.Principal.F.Id.EffectiveType.GenericEquals(r.F.PrincipalID, F.Id));
			}
		}
		#endregion
		...
		public class RoleDataTable : DBIDataTable {
			...
			public RoleRow AddNewRoleRow() {
				return ((RoleRow)(((DBDataSet)this.DataSet).DB.AddNewRowAndBases((DBDataSet)this.DataSet, dsPermission_1_0_4_14_To_1_0_10_15.Schema.T.Role)));
			}
			protected override DataRow NewRowFromBuilder(DataRowBuilder builder) {
		...
		public class RoleRow : DBIDataRow {
			...
			public IEnumerable<PrincipalRow> GetPrincipalRoleIDChildRows() {
				return ((dsPermission_1_0_4_14_To_1_0_10_15)Table.DataSet).T.Principal.OfType<PrincipalRow>().Where(r => Schema.T.Role.F.Id.EffectiveType.GenericEquals(r.F.RoleID, F.Id));
			}
		}
		#endregion
		...
		public class UserDataTable : DBIDataTable {
			...
			public UserRow AddNewUserRow() {
				return ((UserRow)(((DBDataSet)this.DataSet).DB.AddNewRowAndBases((DBDataSet)this.DataSet, dsPermission_1_0_4_14_To_1_0_10_15.Schema.T.User)));
			}
			protected override DataRow NewRowFromBuilder(DataRowBuilder builder) {
		...
		public class UserRow : DBIDataRow {
			...
			public IEnumerable<UserPermissionRow> GetUserPermissionUserIDChildRows() {
				return ((dsPermission_1_0_4_14_To_1_0_10_15)Table.DataSet).T.UserPermission.OfType<UserPermissionRow>().Where(r => Schema.T.User.F.Id.EffectiveType.GenericEquals(r.F.UserID, F.Id));
			}
			public IEnumerable<PrincipalRow> GetPrincipalUserIDChildRows() {
				return ((dsPermission_1_0_4_14_To_1_0_10_15)Table.DataSet).T.Principal.OfType<PrincipalRow>().Where(r => Schema.T.User.F.Id.EffectiveType.GenericEquals(r.F.UserID, F.Id));
			}
		}
		#endregion
		...
		public class UserPermissionDataTable : DBIDataTable {
			...
			public UserPermissionRow AddNewUserPermissionRow() {
				return ((UserPermissionRow)(((DBDataSet)this.DataSet).DB.AddNewRowAndBases((DBDataSet)this.DataSet, dsPermission_1_0_4_14_To_1_0_10_15.Schema.T.UserPermission)));
			}
			protected override DataRow NewRowFromBuilder(DataRowBuilder builder) {
		...
		public class UserRoleDataTable : DBIDataTable {
			...
			public UserRoleRow AddNewUserRoleRow() {
				return ((UserRoleRow)(((DBDataSet)this.DataSet).DB.AddNewRowAndBases((DBDataSet)this.DataSet, dsPermission_1_0_4_14_To_1_0_10_15.Schema.T.UserRole)));
			}
			protected override DataRow NewRowFromBuilder(DataRowBuilder builder) {
		...
		public class SchemaClass : DBI_Database {
			...
			private SchemaClass() {
				...
				CompleteDBI(System.Reflection.Assembly.GetExecutingAssembly(), "manifest://localhost/Thinkage/MainBoss/Database/Upgrade/Schema/dsPermission_1_0_4_14_To_1_0_10_15.xafdb", typeof(dsPermission_1_0_4_14_To_1_0_10_15));
			 }
			/// <summary>
			...
			public class DBI_Principal : DBIDataDBI_Table {
				...
				public override void SetupVariables() {
					// The columns are predefined by the Xml load. In theory they are in the same order as when this file
					// was built and we could find them by index, but finding them by name is more bullet-proof.
					System.Diagnostics.Debug.Assert(Columns.Count == 5, "Table 'Principal' column count mismatch");
					__Id = Columns["Id"];
					System.Diagnostics.Debug.Assert(__Id != null, "Column 'Id' not found");
					__Desc = Columns["Desc"];
			...
			public class DBI_UserRole : DBIDataDBI_Table {
				...
				public override void SetupVariables() {
					// The columns are predefined by the Xml load. In theory they are in the same order as when this file
					// was built and we could find them by index, but finding them by name is more bullet-proof.
					System.Diagnostics.Debug.Assert(Columns.Count == 1, "Table 'UserRole' column count mismatch");
					__Id = Columns["Id"];
					System.Diagnostics.Debug.Assert(__Id != null, "Column 'Id' not found");
					F = new FAccessor(this);
				}
			...
			public struct TAccessor {
				...
				/// <summary>
				/// Denotes the UserPermission table with labelkey='User Permission'
				/// </summary>
				public DBI_UserPermission UserPermission { get { return this_schema.__UserPermission; }}
				/// <summary>
				/// Denotes the UserRole table with labelkey='UserRole'
				/// </summary>
		...
		public class PathClass {
			...
			public class PathToPrincipalRow : DBI_PathToRow {
				...
				public class FAccessor {
					...
					/// <summary>
					/// Provides the path to Principal's Desc with type string(minlength 1, maxlength 150, maxlines 0, trim) and labelkey='Desc'
					/// </summary>
					public PathToField Desc { get { if (_BasePath._Desc == null) _BasePath._Desc = new PathToField(_BasePath, Schema.T.Principal.F.Desc ); return _BasePath._Desc; } }
					/// <summary>
					/// Provides the path to Principal's Comment with type string(minlength 1, (maxlength 1,073,741,823), trim) and labelkey='Comment'
					/// </summary>
					public PathToField Comment { get { if (_BasePath._Comment == null) _BasePath._Comment = new PathToField(_BasePath, Schema.T.Principal.F.Comment ); return _BasePath._Comment; } }
					/// <summary>
			...
			public struct TAccessor {
				...
				/// <summary>
				/// Provides the root path for UserPermission with labelkey='User Permission'
				/// </summary>
				public PathToUserPermissionRow UserPermission { get { return this_path.__pUserPermission; } }
				/// <summary>
				/// Provides the root path for UserRole with labelkey='UserRole'
				/// </summary>
