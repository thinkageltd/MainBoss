	...
	public class dsSqlServers : DBDataSet {
		...
		protected dsSqlServers(SerializationInfo info, StreamingContext context) {
			...
			if ((strSchema != null)) {
				...
				if ((ds.Tables["SqlServers"] != null)) {
					this.Tables.Add(new SqlServersDataTable(ds.Tables["SqlServers"]));
				}
		...
		public class TAccessor {
			public TAccessor( dsSqlServers this_dataset ) {
				this.SqlServers = (SqlServersDataTable)this_dataset.Tables["SqlServers"];
			}
		...
		public class DTAccessor {
			public DTAccessor( dsSqlServers this_dataset ) {
				this.SqlServers = (SqlServersDataTable)this_dataset.Tables["_DSqlServers"];
			}
			public readonly SqlServersDataTable SqlServers;
		}
		#endregion
		...
		[Thinkage.Libraries.Translation.Invariant]
		public class SqlServersDataTable : DBIDataTable {
			#region Construction
...
#if SerializationSupport
			internal SqlServersDataTable(DataTable table) :
			...
			internal class FAccessor {
				public FAccessor(SqlServersDataTable t) {
				  ...
				  this.Server = (DBIDataColumn)t.Columns["Server"];
				  this.Instance = (DBIDataColumn)t.Columns["Instance"];
				  this.Version = (DBIDataColumn)t.Columns["Version"];
				  this.IsClustered = (DBIDataColumn)t.Columns["IsClustered"];
				}
				/// <summary>
			...
			protected override DataTable CreateInstance() {
				return new SqlServersDataTable(Schema, Server);
			}
			#endregion
			...
			public SqlServersRow this[int index] {
				get {
					return ((SqlServersRow)(this.Rows[index]));
				}
			}
			public void AddSqlServersRow(SqlServersRow row) {
				this.Rows.Add(row);
			}
			public SqlServersRow AddNewSqlServersRow() {
				return ((SqlServersRow)(((DBDataSet)this.DataSet).DB.AddNewRowAndBases((DBDataSet)this.DataSet, dsSqlServers.Schema.T.SqlServers)));
			}
			protected override DataRow NewRowFromBuilder(DataRowBuilder builder) {
				return new SqlServersRow(builder);
			}
			protected override System.Type GetRowType() {
				return typeof(SqlServersRow);
			}
			public void RemoveSqlServersRow(SqlServersRow row) {
		...
		[Thinkage.Libraries.Translation.Invariant]
		public class SqlServersRow : DBIDataRow {
			public FAccessor F {
				get {
					if (_F == null)
						_F = new FAccessor(this);
			...
			private FAccessor _F = null;
			internal SqlServersRow(DataRowBuilder rb)
				: base(rb) {
			}
			[Thinkage.Libraries.Translation.Invariant]
