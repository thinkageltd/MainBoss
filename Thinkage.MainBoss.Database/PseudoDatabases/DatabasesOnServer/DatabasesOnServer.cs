...
namespace Thinkage.MainBoss.Database {
	...
	public class dsDatabasesOnServer : DBDataSet {
		...
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
		public dsDatabasesOnServer(DBClient db) : base(Schema, db) {
			CommonCTOR();
		}
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
		...
		protected dsDatabasesOnServer(SerializationInfo info, StreamingContext context) {
			...
			if ((strSchema != null)) {
				...
				if ((ds.Tables.FindTableDuringTableConstruction(SchemaClass.Instance.T.DatabasesOnServer) != null)) {
					this.Tables.Add(new DatabasesOnServerDataTable(ds.Tables.FindTableDuringTableConstruction(SchemaClass.Instance.T.DatabasesOnServer)));
				}
		...
		public class TAccessor {
			public TAccessor( dsDatabasesOnServer this_dataset ) {
				this.DatabasesOnServer = (DatabasesOnServerDataTable)this_dataset.Tables.FindTableDuringTableConstruction(SchemaClass.Instance.T.DatabasesOnServer);
			}
		...
		#region DatabasesOnServerDataTable
		...
		[Thinkage.Libraries.Translation.Invariant]
		public class DatabasesOnServerDataTable : DBICustomDataTable<DatabasesOnServerRow> {
			#region Construction
...
#if SerializationSupport
			internal DatabasesOnServerDataTable(System.Data.DataTable table) :
			...
			internal class FAccessor {
				public FAccessor(DatabasesOnServerDataTable t) {
				  this.Id = t.Columns.FindColumnDuringTableConstruction(SchemaClass.Instance.T.DatabasesOnServer.F.Id);
				  this.ServerName = t.Columns.FindColumnDuringTableConstruction(SchemaClass.Instance.T.DatabasesOnServer.F.ServerName);
				  this.Database = t.Columns.FindColumnDuringTableConstruction(SchemaClass.Instance.T.DatabasesOnServer.F.Database);
				  this.Version = t.Columns.FindColumnDuringTableConstruction(SchemaClass.Instance.T.DatabasesOnServer.F.Version);
				  this.OrganizationName = t.Columns.FindColumnDuringTableConstruction(SchemaClass.Instance.T.DatabasesOnServer.F.OrganizationName);
				  this.UserRecordExists = t.Columns.FindColumnDuringTableConstruction(SchemaClass.Instance.T.DatabasesOnServer.F.UserRecordExists);
				  this.AccessError = t.Columns.FindColumnDuringTableConstruction(SchemaClass.Instance.T.DatabasesOnServer.F.AccessError);
				}
				/// <summary>
			...
			protected override void OnRowChanged(DataRowChangeEventArgs e) {
				base.OnRowChanged(e);
				this.DatabasesOnServerRowChanged?.Invoke(this, new DatabasesOnServerRowChangeEvent(((DatabasesOnServerRow)(e.Row)), e.Action));
			}
			protected override void OnRowChanging(DataRowChangeEventArgs e) {
				base.OnRowChanging(e);
				this.DatabasesOnServerRowChanging?.Invoke(this, new DatabasesOnServerRowChangeEvent(((DatabasesOnServerRow)(e.Row)), e.Action));
			}
			protected override void OnRowDeleted(DataRowChangeEventArgs e) {
				base.OnRowDeleted(e);
				this.DatabasesOnServerRowDeleted?.Invoke(this, new DatabasesOnServerRowChangeEvent(((DatabasesOnServerRow)(e.Row)), e.Action));
			}
			protected override void OnRowDeleting(DataRowChangeEventArgs e) {
				base.OnRowDeleting(e);
				this.DatabasesOnServerRowDeleting?.Invoke(this, new DatabasesOnServerRowChangeEvent(((DatabasesOnServerRow)(e.Row)), e.Action));
			}
			#endif
			#endregion
			protected override DBIDataTable CreateDBIInstance() => new DatabasesOnServerDataTable(Schema, Server);
			public DatabasesOnServerRow AddNewRow() => (DatabasesOnServerRow)DataSet.DB.AddNewRowAndBasesForGeneratedClass(DataSet, dsDatabasesOnServer.Schema.T.DatabasesOnServer);
			protected override DBIDataRow NewDBIRowFromBuilder(System.Data.DataRowBuilder builder) => new DatabasesOnServerRow(builder);
			public new dsDatabasesOnServer DataSet => (dsDatabasesOnServer)base.DataSet;
		}
		#region DatabasesOnServerRow
		[Thinkage.Libraries.Translation.Invariant]
		public class DatabasesOnServerRow : DBICustomDataRow<DatabasesOnServerDataTable> {
			#region Construction
			internal DatabasesOnServerRow(System.Data.DataRowBuilder rb)
				: base(rb) {
			}
			#endregion
			#region Typed Column accessor
		...
		public class SchemaClass : DBI_Database {
			...
			private SchemaClass() {
				...
				CompleteDBI(System.Reflection.Assembly.GetExecutingAssembly(), "manifest://localhost/Thinkage/MainBoss/Database/PseudoDatabases/DatabasesOnServer/DatabasesOnServer.xafdb", typeof(dsDatabasesOnServer)
				);
			 }
			/// <summary>
			...
			/// </summary>
			public class DBI_DatabasesOnServer : DBIDataDBI_Table {
				public FAccessor F;
				...
				internal DBI_DatabasesOnServer()
					: base("DatabasesOnServer", (DBI_Table tableSchema, IServer s) => new DatabasesOnServerDataTable(tableSchema, s)) {
				}
