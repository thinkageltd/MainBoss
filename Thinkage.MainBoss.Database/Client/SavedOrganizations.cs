...
//		Vault version 108
//		XAFBuild title: Thinkage.XAFBuild.StudioAddin in Thinkage ToolKit 2.0.19.0
...
namespace Thinkage.MainBoss.Database {
	...
	public class dsSavedOrganizations : XAFDataSet {
		...
		public class VAccessor {
			...
			public readonly NullableDataVariable<System.Guid> PreferredOrganization;
			public readonly NullableDataVariable<System.Guid> PreferredOrganizationDebug;
			public readonly NullableDataVariable<System.Guid> SoloOrganization;
			#endregion
			...
			public VAccessor(dsSavedOrganizations this_dataset )
			{
				...
				this.PreferredOrganization = (NullableDataVariable<System.Guid>) this_dataset.AddDataVariable( Schema.V.PreferredOrganization );
				this.PreferredOrganizationDebug = (NullableDataVariable<System.Guid>) this_dataset.AddDataVariable( Schema.V.PreferredOrganizationDebug );
				this.SoloOrganization = (NullableDataVariable<System.Guid>) this_dataset.AddDataVariable( Schema.V.SoloOrganization );
			}
			#endregion
		}
		#endregion
		...
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
		public dsSavedOrganizations(XAFClient db) : base(Schema, db) {
			CommonCTOR();
		}
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
		...
		public class OrganizationsDataTable : DBIDataTable {
			...
			internal class FAccessor {
				public FAccessor(OrganizationsDataTable t) {
				  ...
				  this.DataBaseName = (DBIDataColumn)t.Columns["DataBaseName"];
				  this.DataBaseServer = (DBIDataColumn)t.Columns["DataBaseServer"];
				  this.CredentialsAuthenticationMethod = (DBIDataColumn)t.Columns["CredentialsAuthenticationMethod"];
				  this.CredentialsPassword = (DBIDataColumn)t.Columns["CredentialsPassword"];
				  this.CredentialsUsername = (DBIDataColumn)t.Columns["CredentialsUsername"];
				  this.CompactBrowsers = (DBIDataColumn)t.Columns["CompactBrowsers"];
				  this.PreferredApplicationMode = (DBIDataColumn)t.Columns["PreferredApplicationMode"];
				  this.IsPreferredOrganization = (DBIDataColumn)t.Columns["IsPreferredOrganization"];
				  this.DBVersion = (DBIDataColumn)t.Columns["DBVersion"];
				  this.Access = (DBIDataColumn)t.Columns["Access"];
				  this.CanDropDatabase = (DBIDataColumn)t.Columns["CanDropDatabase"];
			...
			public OrganizationsRow AddNewOrganizationsRow() {
				return ((OrganizationsRow)(((DBDataSet)this.DataSet).DB.AddNewRowAndBases((DBDataSet)this.DataSet, dsSavedOrganizations.Schema.T.Organizations)));
			}
		...
		[Thinkage.Libraries.Translation.Invariant]
		public class OrganizationsRow : DataRow {
			public FAccessor F {
				get {
					if (_F == null)
						_F = new FAccessor(this);
		...
		public class SchemaClass : DBI_Database {
			...
			/// </summary>
			public class DBI_Organizations : DBI_Table {
				public FAccessor F;
				...
				internal DBI_Organizations()
					: base( "Organizations",
							delegate(DBI_Table tableSchema, IServer s) {
								return new OrganizationsDataTable(tableSchema, s);
							}
						) {
				}
