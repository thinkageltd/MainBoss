...
namespace Thinkage.MainBoss.Database {
	...
	public class dsPhysicalCount : XAFDataSet {
		...
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
		public dsPhysicalCount(XAFClient db) : base(Schema, db) {
			CommonCTOR();
		}
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
		...
		[Thinkage.Libraries.Translation.Invariant]
		public class PhysicalCountRow : DataRow {
			public FAccessor F {
				get {
					if (_F == null)
						_F = new FAccessor(this);
		...
		public class SchemaClass : DBI_Database {
			...
			/// </summary>
			public class DBI_PhysicalCount : DBI_Table {
				public FAccessor F;
				...
				internal DBI_PhysicalCount()
					: base( "PhysicalCount",
							delegate(DBI_Table tableSchema, IServer s) {
								return new PhysicalCountDataTable(tableSchema, s);
							}
						) {
				}
