...
namespace Thinkage.MainBoss.Database {
	...
	public class dsSecurityOnServer : XAFDataSet {
		...
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
		public dsSecurityOnServer(XAFClient db) : base(Schema, db) {
			CommonCTOR();
		}
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
		...
		protected dsSecurityOnServer(SerializationInfo info, StreamingContext context) {
			...
			if ((strSchema != null)) {
				...
				if ((ds.Tables["SecurityOnServer"] != null)) {
					this.Tables.Add(new SecurityOnServerDataTable(ds.Tables["SecurityOnServer"]));
				}
		...
		public class TAccessor {
			public TAccessor( dsSecurityOnServer this_dataset ) {
				this.SecurityOnServer = (SecurityOnServerDataTable)this_dataset.Tables["SecurityOnServer"];
			}
		...
		public class DTAccessor {
			public DTAccessor( dsSecurityOnServer this_dataset ) {
				this.SecurityOnServer = (SecurityOnServerDataTable)this_dataset.Tables["_DSecurityOnServer"];
			}
			public readonly SecurityOnServerDataTable SecurityOnServer;
		}
		#endregion
		...
		[Thinkage.Libraries.Translation.Invariant]
		public class SecurityOnServerDataTable : DBIDataTable {
			#region Construction
...
#if SerializationSupport
			internal SecurityOnServerDataTable(DataTable table) :
			...
			internal class FAccessor {
				public FAccessor(SecurityOnServerDataTable t) {
				  ...
				  this.CredentialAuthenticationMethod = (DBIDataColumn)t.Columns["CredentialAuthenticationMethod"];
				  this.DBUserName = (DBIDataColumn)t.Columns["DBUserName"];
				  this.LoginName = (DBIDataColumn)t.Columns["LoginName"];
				  this.Password = (DBIDataColumn)t.Columns["Password"];
				  this.InMainBossRole = (DBIDataColumn)t.Columns["InMainBossRole"];
				  this.IsSysAdmin = (DBIDataColumn)t.Columns["IsSysAdmin"];
				  this.IsDBO = (DBIDataColumn)t.Columns["IsDBO"];
				  this.IsLoginManager = (DBIDataColumn)t.Columns["IsLoginManager"];
				  this.Enabled = (DBIDataColumn)t.Columns["Enabled"];
				  this.Generation = (DBIDataColumn)t.Columns["Generation"];
				}
			...
			protected override void OnRowChanged(DataRowChangeEventArgs e) {
				base.OnRowChanged(e);
				if ((this.SecurityOnServerRowChanged != null)) {
					this.SecurityOnServerRowChanged(this, new SecurityOnServerRowChangeEvent(((SecurityOnServerRow)(e.Row)), e.Action));
				}
			}
			protected override void OnRowChanging(DataRowChangeEventArgs e) {
				base.OnRowChanging(e);
				if ((this.SecurityOnServerRowChanging != null)) {
					this.SecurityOnServerRowChanging(this, new SecurityOnServerRowChangeEvent(((SecurityOnServerRow)(e.Row)), e.Action));
				}
			}
			protected override void OnRowDeleted(DataRowChangeEventArgs e) {
				base.OnRowDeleted(e);
				if ((this.SecurityOnServerRowDeleted != null)) {
					this.SecurityOnServerRowDeleted(this, new SecurityOnServerRowChangeEvent(((SecurityOnServerRow)(e.Row)), e.Action));
				}
			}
			protected override void OnRowDeleting(DataRowChangeEventArgs e) {
				base.OnRowDeleting(e);
				if ((this.SecurityOnServerRowDeleting != null)) {
					 this.SecurityOnServerRowDeleting(this, new SecurityOnServerRowChangeEvent(((SecurityOnServerRow)(e.Row)), e.Action));
				}
			}
			#endif
			#endregion
			...
			protected override DataTable CreateInstance() {
				return new SecurityOnServerDataTable(Schema, Server);
			}
			#endregion
			...
			public SecurityOnServerRow this[int index] {
				get {
					return ((SecurityOnServerRow)(this.Rows[index]));
				}
			}
			public void AddSecurityOnServerRow(SecurityOnServerRow row) {
				this.Rows.Add(row);
			}
			public SecurityOnServerRow AddNewSecurityOnServerRow() {
				return ((SecurityOnServerRow)(((DBDataSet)this.DataSet).DB.AddNewRowAndBases((DBDataSet)this.DataSet, dsSecurityOnServer.Schema.T.SecurityOnServer)));
			}
			protected override DataRow NewRowFromBuilder(DataRowBuilder builder) {
				return new SecurityOnServerRow(builder);
			}
			protected override System.Type GetRowType() {
				return typeof(SecurityOnServerRow);
			}
			public void RemoveSecurityOnServerRow(SecurityOnServerRow row) {
		...
		[Thinkage.Libraries.Translation.Invariant]
		public class SecurityOnServerRow : DataRow {
			public FAccessor F {
				get {
					if (_F == null)
						_F = new FAccessor(this);
			...
			private FAccessor _F = null;
			internal SecurityOnServerRow(DataRowBuilder rb)
				: base(rb) {
			}
			[Thinkage.Libraries.Translation.Invariant]
		...
		public class SchemaClass : DBI_Database {
			...
			/// </summary>
			public class DBI_SecurityOnServer : DBI_Table {
				public FAccessor F;
				...
				internal DBI_SecurityOnServer()
					: base( "SecurityOnServer",
							delegate(DBI_Table tableSchema, IServer s) {
								return new SecurityOnServerDataTable(tableSchema, s);
							}
						) {
				}
