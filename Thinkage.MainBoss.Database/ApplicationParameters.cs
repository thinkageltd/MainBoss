...
namespace Thinkage.MainBoss.Database {
	...
	static public class ApplicationParameters {
		...
		public static string HelpFileOnlineLocation {
			get {
				return Strings.IFormat("http://mainboss.com/english/manual/{0}.{1}.{2}/HtmlHelp/{3}", VersionInfo.ProductVersion.Major, VersionInfo.ProductVersion.Minor, VersionInfo.ProductVersion.Build, Thinkage.Libraries.Application.InstanceCultureInfo.TwoLetterISOLanguageName);
			}
		}
		/// <summary>
