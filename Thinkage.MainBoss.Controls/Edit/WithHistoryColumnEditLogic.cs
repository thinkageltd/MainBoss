...
namespace Thinkage.MainBoss.Controls
{
	...
	public class WithHistoryColumnEditLogic : EditLogic {
		#region Constructors
		public WithHistoryColumnEditLogic(IEditUI control, DBClient db, Tbl tbl, Settings.Container settingsContainer, EdtMode initialEditMode, object[][] initRowIDs, bool[] subsequentModeRestrictions, List<TblActionNode>[] initLists)
