...
(function ($) {
    ...
    function initJQueryUI(elements) {
        ...
        elements.filter('[data-jqui-type="datetimepicker"]').each(function () {
            var dp = $(this);
            var options = createOptions(dp, 'data-jqui-dpicker-',
                ['altField', 'altFormat', 'appendText', 'autoSize', 'buttonImage', 'buttonImageOnly', 'buttonText',
                    'changeMonth', 'changeYear', 'closeText', 'constrainInput', 'currentText', 'dateFormat', 'defaultDate', 'disabled',
                    ...
                    'timeFormat', 'timeSuffix', 'timeOnlyTitle', 'timeText', 'hourText', 'minuteText', 'secondText', 'millisecText', 'microsectText', 'timezoneText',
                    'altFieldTimeOnly', 'altSeparator', 'altTimeSuffix', 'altTimeFormat', 'altRedirectFocus',
                    'showHour', 'showMinute', 'showSecond', 'showMillisec', 'showMicrosec', 'showTime', 'stepHour', 'stepMinute', 'stepSecond', 'stepMillisec', 'stepMicrosec',
                    'hour', 'minute', 'second', 'millisec', 'microsec', 'timezone', 'hourMin', 'minuteMin', 'secondMin', 'millisecMin', 'microsecMin', 'hourMax', 'minuteMax',
                    'secondMax', 'millisecMax', 'microsecMax', 'hourGrid', 'minuteGrid', 'secondGrid', 'millisecGrid', 'microsecGrid', 'separator', 'pickerTimeFormat', 'pickerTimeSuffix',
                    'showTimePicker', 'addSliderAccess', 'sliderAccessArgs', 'defaultValue'
                ],
                ['dayNames', 'dayNamesMin', 'dayNamesShort', 'monthNames', 'monthNamesShort',
                    // timepicker only array options
                    'timezoneList', 'amNames', 'pmNames'
                ],
                ['calculateWeek', 'beforeShow', 'beforeShowDay', 'onChangeMonthYear', 'onClose', 'onSelect'], [],
                ['numberOfMonths']
            );
